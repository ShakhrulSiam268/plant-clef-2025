...
```shell
python segment_bbox.py
```
This will generate bounding boxes from all the test images using GroudingDINO model.

![Sample Test Image](sample_data/test_image_1.png)

### Generating Prediction
Run the following command to get classification result using `BioCLIP-2 + GroundingDINO`.
```shell
